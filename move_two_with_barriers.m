function [X1, Y1, X2, Y2] = move_two_with_barriers(X1, Y1, X2, Y2, Bx, By, alpha, beta, gamma, c_energy, max_iter, min_dist)
% get h
h1 = get_h(X1, Y1);
h2 = get_h(X2, Y2);
...
while i < max_iter
    ...
    [Ex1, Ey1] = get_E(X1, Y1, [X2;Bx], [Y2;By], min_dist, c_energy);
    [Ex2, Ey2] = get_E(X2, Y2, [X1;Bx], [Y1;By], min_dist, c_energy);
